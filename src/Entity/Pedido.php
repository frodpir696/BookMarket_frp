...
class Pedido
{
    ...
    public function getComprador(): ?User { return $this->comprador; }
    public function setComprador(User $comprador): static { $this->comprador = $comprador; return $this; }

    /** @return Collection<int, Book> */
    public function getBooks(): Collection { return $this->books; }
    public function addBook(Book $book): static { if (!$this->books->contains($book)) { $this->books->add($book); } return $this; }
    public function removeBook(Book $book): static { $this->books->removeElement($book); return $this; }
}
